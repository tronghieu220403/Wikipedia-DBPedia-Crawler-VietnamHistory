...
public class WikiData extends EntityHandling{
    ...
    public static HashSet<String> getAllHref(String wikiPageData, String subID, boolean getCategory) throws Exception{
    ...
    public static HashSet<String> getAllHref(String wikiPageData) throws Exception
    {
